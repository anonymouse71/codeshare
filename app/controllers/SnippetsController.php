...
class SnippetsController extends BaseController{
	...
	public function getIndex(){
		$this->layout->content = View::make('snippets.index')->with('snippets' , Snippet::take(5)->
			orderBy('id' , 'desc')->get());
	}
	...
	public function postCreate(){
		...
		if ($validator->passes()) {
			...
			return Redirect::to('snippets/index')->with('message' , 'The following errors occured')->withErrors($validator)->withInput();
		}
